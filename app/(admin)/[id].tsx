...
export default function VendorProductDetails() {
    ...
    // Handle back navigation - FIXED: Navigate to admin products
    const handleBack = () => {
        console.log('Navigating back to admin products');
        router.push('/(admin)/dropShipping'); // Adjust this path to match your admin products screen
    };
...
// FIXED: DetailItem component with proper Text wrapper
