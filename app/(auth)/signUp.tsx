...
import { useBiometric } from '@/context/BiometricContext'; // Add this
import { BiometricLoginButton } from '@/components/BiometricLoginButton'; // Add this
        ...
        <View className="flex-1 bg-white">
            ...
            <View className="flex-1 bg-white -mt-8 rounded-t-3xl">
                <View className="px-6 pt-8">
                    ...
                    {showBiometric && (
                        <View className="mb-6">
                            <BiometricLoginButton variant="full" />
